const fruits:string[] = ["Apple","Banana","mongo"];
...
//concat two arrays
const otherFruits:string[] = ["Kiwi","Lemon"]
...
//slice method
const array1:string[] = fruits.slice(0,2)
console.log(array1);


const numbers:number[] = [3,2,6,2,4,6,8,0]
...
//map function
const squere:number[] = numbers.map(number => number * number)
console.log(squere);
...
//reduse method
console.log(numbers.reduce((total=0,value:number)=> total + value))
